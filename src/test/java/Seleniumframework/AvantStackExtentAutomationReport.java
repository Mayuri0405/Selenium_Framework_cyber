...
public class AvantStackExtentAutomationReport extends BaseClasss {
	/**
	...
	*/
	...
	ExtentSparkReporter sparkReport= new ExtentSparkReporter(System.getProperty("user.dir")+ "/target/ExtentReport/ExtentReport.pdf");
